...
namespace TRGE.Core.Test
{
    public class TR2PSXBetaAudioTests : AbstractTR23AudioTestCollection
    {
        ...
        internal override Dictionary<string, ushort> ExpectedLevelTracks => new Dictionary<string, ushort>
        {
            ...
            [AbstractTRLevel.CreateID(@"data\living.PSX")] = 32,
            [AbstractTRLevel.CreateID(@"data\deck.PSX")] = 32,
            ...
            [AbstractTRLevel.CreateID(@"data\icecave.PSX")] = 32,
            ...
            [AbstractTRLevel.CreateID(@"data\house.PSX")] = 18
        };
